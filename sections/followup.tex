...
implementation. This checkpoint intervention alone does not assess its
learning behavior; the subsequent training experiment is described below.

A subsequent 24-run CIFAR-100 campaign trains both selectors from scratch
with three seeds and a degree-matched control
(Section~\ref{sec:cifar-seeds}). Those endpoints are new trainings, not
re-evaluations of the two August checkpoints in this appendix.
