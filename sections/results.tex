...
reports a best EMA value of 81.368\%. Dense DeiT-S/8 reaches 82.246\%, while
post-training ToMe and PiToMe reach 81.932\% and 81.742\%, respectively. Thus
the current evidence establishes a learnable physical bottleneck, but not a
stronger accuracy frontier. The matched DTEM score and common-protocol systems
cells remain explicit blanks.
...
realized receiver degree. Across three seeds, radius 3 ranks first among the
four geometries (Table~\ref{tab:cifar-seeds}). Every one of the nine paired
radius-3 minus control differences is positive. Against the degree-matched
control, the mean gain is $1.42\pm0.30$ points. These runs support a locality
effect beyond degree, but do not transfer ImageNet uncertainty.
