...
tests GPU/autocast inference with local CIFAR weights; full-model training
stability of this selector remains untested. Mass tolerances in these checks are $5\times10^{-4}$ for float32
...
2026-09-15. The complete packet was inspected. Company policy prevents ImageNet weight
transfer; independent ImageNet checkpoint re-evaluation is unavailable.
